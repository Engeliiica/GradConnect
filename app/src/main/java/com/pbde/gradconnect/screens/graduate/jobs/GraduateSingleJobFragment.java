...
public class GraduateSingleJobFragment extends Fragment {
    private GraduateSingleJobViewModel viewModel;
    ...
    public static GraduateSingleJobFragment newInstance() {
        return new GraduateSingleJobFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                           @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_graduate_single_job, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(GraduateSingleJobViewModel.class);
    ...
    private void setupButtonListeners() {
        btnApply.setOnClickListener(v -> {
            ...
            Navigation.findNavController(v)
                    .navigate(R.id.action_navigation_graduate_single_job_to_navigation_graduate_job_application, bundle);
        });
